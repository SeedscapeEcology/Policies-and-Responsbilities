...
* I expect everyone in the group to continuously educate yourself and actively engage in diversity, equity, and inclusion efforts. Read books! [(A living document of resources.)](https://github.com/SeedscapeEcology/Onboarding/blob/master/DiversityEquityInclusionReadingList.md) Participate in events offered by USU ([Division of DEI](https://www.usu.edu/dei/)) or at conferences you are attending (e.g., opportunities @ [ESA](https://www.esa.org/esa/education-and-diversity/diversity-in-ecology/), [SACNAS](http://sacnas.org)). 
